  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <button className="btn btn-github" onClick={() => handleGitHubClick("https://github.com/Jayasreedeveloper")}>
            <svg
          ...
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                ...
                <p className="text-sm portfolio--link" onClick={() => handleGitHubClick(item.link)} style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline' }}>
                  Visit on site
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
